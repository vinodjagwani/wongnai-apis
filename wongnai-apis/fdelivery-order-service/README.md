...
1. Download Java Java SDK v1.8 or higher from https://www.oracle.com/java/technologies/javase/jdk17-archive-downloads.html
...
### fdelivery-order-service apis
1. Swagger (api documentation) url: http://localhost:8089/fdelivery-order-service/swagger-ui/index.html
...
### How to run fdelivery-order-service
...
3. check the swagger once service is up: http://localhost:8089/fdelivery-order-service/swagger-ui/index.html
