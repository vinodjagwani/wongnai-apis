...
public class SwaggerConfig {
    ...
    public Docket docket() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("th.wongnai.fdelivery.order.feature.web.rest"))
    ...
    public ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Wongnai Thailand Order Service")
                .contact(new Contact("Wongani Thailand", "", "")).version("1.0").build();
    }
